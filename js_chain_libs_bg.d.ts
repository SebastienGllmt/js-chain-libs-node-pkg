...
export function __wbg_genesisproasleaderhash_free(a: number): void;
export function genesisproasleaderhash_from_hex(a: number, b: number): number;
export function genesisproasleaderhash_to_string(a: number, b: number): void;
