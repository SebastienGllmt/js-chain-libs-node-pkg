...
export function poolregistration_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function witness_for_legacy_utxo(a: number, b: number, c: number): number;
export function witness_from_external_legacy_utxo(a: number, b: number): number;
