...
export function __wbg_percertificatefee_free(a: number): void;
export function percertificatefee_new(): number;
export function percertificatefee_set_pool_registration(a: number, b: number): void;
export function percertificatefee_set_stake_delegation(a: number, b: number): void;
export function percertificatefee_set_owner_stake_delegation(a: number, b: number): void;
export function __wbg_fee_free(a: number): void;
export function fee_linear_fee(a: number, b: number, c: number, d: number): number;
